  ...
  return (
    <>
      ...
      <button
        ...
        className={clsx(
          "fixed bottom-24 right-6 z-40 p-4 rounded-full bg-white text-black border border-black shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:scale-105 transition-all duration-300 flex items-center justify-center",
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 bg-black text-white shrink-0 shadow-md">
                ...
                <div className="flex items-center gap-1.5 mb-1 opacity-70">
                  {m.role === "user" ? (
                    ...
                    <>
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider text-black">Kia</span>
                    </>
                  )}
                </div>
                <div 
